...
const SPECIAL_ATTACK_THRESHOLD: float = 6.0
...
func track_and_match_entity(entity: CharacterBody2D, overall_throttle: float = 1.0) -> void:
	...
	velocity.y = direction * scalar_speed * percent_throttle * overall_throttle * ball_dangerous_throttle
